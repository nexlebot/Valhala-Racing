...
const OurFacility = () => {
    return (
        <div className='mx-6 lg:mx-12'>
            <SectionHeader title='Our Facilities' subtitle='World-class infrastructure built to train champions and inspire excellence.' buttonText='See facilities' buttonVariant='secondary' />
